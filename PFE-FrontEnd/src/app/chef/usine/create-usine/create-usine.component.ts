...
export class CreateUsineComponent implements OnInit {
  ...
  save() {
    if (
      this.myForm.get('nomUsine')?.value == null ||
    ...
    this.usineService
      .getNomUsineUtilse(this.myForm.get('nomUsine')?.value)
      .subscribe((t) => {
        console.log(t);
        if (t == 1) {
          this.msg1 = 1;
        ...
        this.usineService
          .getTelUsineUtilse(this.myForm.get('tel')?.value)
          .subscribe((t1) => {
            console.log(t);
            if (t1 == 1) {
              this.msg2 = 1;
            ...
            if (
              ...
              this.myForm.get('nomUsine')?.value.length >= 3 &&
              this.myForm.get('tel')?.value != null &&
              ...
              this.usineService
                ...
                .subscribe((o) => {
                  ...
                  localStorage.setItem(
                    ...
                    JSON.stringify([
                      'Success',
                      'Une usine a été ajoutée avec succès',
                    ])
                  );
                  this.onClose();
                });
