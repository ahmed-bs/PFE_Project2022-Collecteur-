...
export class DashboardComponent implements OnInit {
  ...
  formatePieData(data: any[]) {
    ...
    for (const element of data) {
      if (!dataArrayYaxis.includes(element.typeOp) && element.typeOp !== null)
        dataArrayYaxis.push(element.typeOp);
    }
  ...
  formateData(data: any[]) {
    ...
    for (const element of data) {
      ...
      if (
        !dataArrayYaxis.includes(dateElement) &&
        dateElement !== 'Invalid Date'
      )
        dataArrayYaxis.push(dateElement);
    }
  ...
  ngOnInit(): void {
    ...
    this.usineService.getNbUsines().subscribe((i) => {
      this.somUsine = i;
      console.log(this.somUsine);
    });

    this.agriculteurService.getNbA().subscribe((i) => {
      this.somAgriculteur = i;
      console.log(this.somAgriculteur);
    });
